...
|------|---------|-------------|
| `--clusterprofile-provider-file` | `""` | Path to the JSON config file describing Cluster Inventory API access providers. Required when any CR sets `spec.placement` or the deprecated `spec.clusterProfileRef`. See [docs/multicluster.md](docs/multicluster.md). |
